...
function cal8(op9) {
    ...
    if (hsslow == "0") {
        Swal.fire ({
            title: 'No se permiten campos vacios en: Valor del mes con el peor promedio de radiación solar diaría del lugar escogido',
            icon: 'warning',
            confirmButtonText: 'Entendido',
            //footer: '<span class="rojo"> Información',
            padding: '1rem',
            backdrop: true,
            //timer: 5000,
...
function cal10(op11) {
    ...
    if (cepfv3 == "0") {
        Swal.fire ({
            title: 'No se permiten campos vacios en: P max [W]',
            icon: 'warning',
            confirmButtonText: 'Entendido',
            //footer: '<span class="rojo"> Información',
            padding: '1rem',
...
function cal11(op12) {
    ...
    if (cepfv1 == "0" || cepfv2 == "0" || cepfv4 == "0" || cepfv5 == "0") {
        Swal.fire ({
            title: 'No se permiten campos vacios en: Características eléctricas del panel fotovoltaico escogido',
            icon: 'warning',
            confirmButtonText: 'Entendido',
            //footer: '<span class="rojo"> Información',
            padding: '1rem',
...
function cal12(op13) {
    ...
    /*if (pepfv2 == "0") {
        Swal.fire ({
            title: 'No se permiten campos vacios en: V max DC [V]',
            icon: 'warning',
            confirmButtonText: 'Entendido',
            //footer: '<span class="rojo"> Información',
            padding: '1rem',
...
function calc3(operation4) {
    ...
    if (pnominv == "0") {
        Swal.fire ({
            title: 'No se permiten campos vacios en: Factor de dimensionamiento del inversor',
            icon: 'warning',
            confirmButtonText: 'Entendido',
            //footer: '<span class="rojo"> Información',
            padding: '1rem',
...
function calc4(operation5) {
    ...
    if (pmaxmod == "0") {
        Swal.fire ({
            title: 'No se permiten campos vacios en: Número de módulos',
            icon: 'warning',
            confirmButtonText: 'Entendido',
            //footer: '<span class="rojo"> Información',
            padding: '1rem',
