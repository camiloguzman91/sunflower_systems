...
function calc2(operation3) {
    ...
    var n2000 = document.getElementById("numpgfv_02").value;
    var n3000 = document.getElementById("numpgfv_03").value;
    var n4000 = document.getElementById("numpgfv_04").value;
    var n5000 = document.getElementById("numpgfv_05").value;
    var n6000 = document.getElementById("numpgfv_06").value;
    var n7000 = document.getElementById("numpgfv_07").value;
    var n8000 = document.getElementById("numpgfv_08").value;
    var n9000 = document.getElementById("numpgfv_09").value;
    var n10000 = document.getElementById("numpgfv_10").value;
    var n11000 = document.getElementById("numpgfv_11").value;
    var n12000 = document.getElementById("numpgfv_12").value;   

    numpgfv_01 = Number(n1000);
    numpgfv_02 = Number(n2000);
    numpgfv_03 = Number(n3000);
    numpgfv_04 = Number(n4000);
    numpgfv_05 = Number(n5000);
    numpgfv_06 = Number(n6000);
    numpgfv_07 = Number(n7000);
    numpgfv_08 = Number(n8000);
    numpgfv_09 = Number(n9000);
    numpgfv_10 = Number(n10000);
    numpgfv_11 = Number(n11000);
    numpgfv_12 = Number(n12000);
